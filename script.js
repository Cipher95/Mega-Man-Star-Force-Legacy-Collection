...
let currentLang = 'en'; // Default language
    ...
    const siteData = {
        en: {
            ...
            specialArtUrl: "mv.webp", // Added Image File Here
            gameTitles: [
    ...
    langButtons.forEach(button => {
        button.addEventListener('click', () => {
            ...
            // Hide language selector and show the intro video
            ...
            introVideo.play().catch(error => {
                ...
                // If autoplay fails, skip straight to the content
                showMainContent();
            });
        });
    });

    // Listen for when the intro video has finished playing
    introVideo.addEventListener('ended', () => {
        showMainContent();
    });

    // Function to hide intro and show the main website
    function showMainContent() {
        introVideoContainer.classList.remove('is-visible');
        mainContent.style.display = 'block';
        playAudio(); // Start background music now
    }
    ...
    function setLanguage(lang) {
        ...
        document.getElementById('special-art-img').src = data.specialArtUrl; // Update Special Art Image
        ...
        if (trailerVideo && trailerSource) {
            ...
            trailerVideo.load(); // Load the new video source
            // The video will attempt to autoplay due to the attribute in the HTML
        }
    ...
    function playAudio() {
        if (backgroundMusic && backgroundMusic.paused) {
            backgroundMusic.play().catch(() => {
                ...
                // Fallback listener in case the initial click doesn't register for audio
